...
public class CmdbDAO {
	...
	public void salvar(Cmdb p) throws SQLException {
		...
		sql.append(" values (seq_planilha.nextval,?,?,?,?,?,?,?,?,?,?,?,?) ");
	...
	public ArrayList<Cmdb> listar() throws SQLException {
		StringBuilder sql = new StringBuilder();
		...
		sql.append(" a.contato1 = u.cod_usuario and ");
		sql.append(" a.cod_empresa = 23 ");
