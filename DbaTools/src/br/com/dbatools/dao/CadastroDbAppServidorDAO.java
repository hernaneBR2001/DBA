...
public class CadastroDbAppServidorDAO {
	...
	public ArrayList<CadastroDbAppServidor> listar() throws SQLException {
		StringBuilder sql = new StringBuilder();

		sql.append(" SELECT a.cod_cadastro, b.cod_planilha, b.ip, ");
		sql.append("        a.tipo, ");
	...
	sql.append("set tipo = ?, nom_cadastro = ?, usuario_bd_app = ?, senha_bd_app = ?  ");
	sql.append("WHERE ");
